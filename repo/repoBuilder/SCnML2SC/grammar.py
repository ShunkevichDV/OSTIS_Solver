...
#SCnFieldCompComment rule
compComm= u"SCnFieldCompComment"+Suppress(V)+level+Suppress(V)+ textIN
SCnFieldCompComment = nestedExpr(B,E,compComm).setResultsName('SCnFieldCompComment') 

#SCnFieldSpecConMemberSet
conMemberSet= u"SCnFieldSpecConMemberSet"+Suppress(V)+level+Suppress(V)+ textIN
SCnFieldSpecConMemberSet = nestedExpr(B,E,conMemberSet).setResultsName('SCnFieldSpecConMemberSet') 

#SCnFieldSpecConPropSuperset rule
conPropSuperset= u"SCnFieldSpecConPropSuperset"+Suppress(V)+level+Suppress(V)+ textIN
SCnFieldSpecConPropSuperset = nestedExpr(B,E,conPropSuperset).setResultsName('SCnFieldSpecConPropSuperset') 

#SCnFieldSpecConSuperset rule
conSuperset= u"SCnFieldSpecConSuperset"+Suppress(V)+level+Suppress(V)+ textIN
SCnFieldSpecConSuperset = nestedExpr(B,E,conSuperset).setResultsName('SCnFieldSpecConSuperset') 

#SCnFieldSpecConPropSubset
conPropSubset= u"SCnFieldSpecConPropSubset"+Suppress(V)+level+Suppress(V)+ textIN
SCnFieldSpecConPropSubset = nestedExpr(B,E,conPropSubset).setResultsName('SCnFieldSpecConPropSubset') 
...
#SCnFieldSpecConSemProxim
conSemProxim= u"SCnFieldSpecConSemProxim" + Suppress(V) + level + Suppress(V) + textIN
SCnFieldSpecConSemProxim = nestedExpr(B,E,conSemProxim).setResultsName('SCnFieldSpecConSemProxim') 
...
#SCnFieldCompArt
compArt= u"SCnFieldCompArt"+Suppress(V)+level+Suppress(V)+oneOf(u'Image Video Media')+Suppress(V)+scnIdtf
...
fieldNames = oneOf(u"SCnFieldSpecRelDomainSet SCnFieldSpecRelDomainSuperSet " \
...
specCon = fieldNames+Suppress(V)+level
